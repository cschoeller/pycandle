...
model_trainer = ModelTrainer(model=model, optimizer=optimizer, loss=F.nll_loss, epochs=RunConfig.epochs,
                                     train_data_loader=train_loader, val_data_loader=val_loader, device=0)
